...
if ($_SESSION['signed_in'] == true) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
		...
		if(isset($open_recaptcha_secret)) {
            ...
            if(!isset($open_recaptcha_secret) || $json['success'] == 0) {
                ...
                $confirmation_code = str_pad(rand(0, pow(10, 32)-1), 32, '0', STR_PAD_LEFT);
                $sql = 'INSERT INTO users(user_name, user_id, user_pass, user_avatar, user_email, user_nnid, user_date, user_rank, user_ip, user_code, user_email_confirmed) VALUES (
                ...
                "' . mysqli_real_escape_string($link, $confirmation_code) . '", 0)';
